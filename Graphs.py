#All implementations assume a 0-indexed adjacency list (unless stated otherwise)

#BFS and DFS are very easy to implement so do it yourself :)


#Djikstra returning shortest distance from start to distance 
from heapq import heappop as pop, heappush as push
dist = [10**18]*n
visited = set()
q = []
start = None #input node here
dist[start] = 0
end = None #input node here
push(q, (0, 0))
while len(q) > 0:
  d, u = pop(q)
  if u in visited:
